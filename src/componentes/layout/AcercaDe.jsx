           ...
           <section className="acerca-de" id="acerca-de">
               <div className="grid">
                    ...
                    <div className="col-2">
                        ...
                        <h3 className="titulo">La razon por la que deberia contratarme</h3>
                        <p className="resumen">
                            Hola! Soy Luis Mir, un apasionado freelancer dedicado a convertir ideas en realidades.
                            Con un enfoque creativo y minucioso, transformo proyectos experiencias unicas.
                            <br/>
                            Mi objetivo es superar tu expectativas en cada colaboracion, brindando soluciones que
